...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="javascript:void(0)"><i class="fa fa-fw fa-envelope"></i> Inbox</a>
                </li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="javascript:void(0)" data-toggle="collapse" data-target="#managePosts"><i class="fa fa-fw fa-arrows-v"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="managePosts" class="collapse">
                    ...
                    <li>
                        <a href="javascript:void(0)">Add Posts</a>
                    </li>
            ...
            <li>
                <a href="javascript:void(0)" data-toggle="collapse" data-target="#manageUsers"><i class="fa fa-fw fa-wrench"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
